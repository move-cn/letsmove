...
module flytam_faucet::flytam_faucet {
  use sui::balance::{Balance};
  use sui::balance;
  use sui::coin::{Self, TreasuryCap};
  public struct FLYTAM_FAUCET has drop {}
  public struct PublicWallet has key {
    id: UID,
    coin: Balance<FLYTAM_FAUCET>,
    faucet_amount: u64,
  }
  ...
  fun init(witness: FLYTAM_FAUCET, ctx: &mut TxContext) {
    let (treasury_cap, metadata) = coin::create_currency<FLYTAM_FAUCET>(
      witness,
      10,
      b"Flytam Faucet",
      b"Flytam Faucet",
  ...
  public entry fun mint_faucet(
    treasury_cap: &mut TreasuryCap<FLYTAM_FAUCET>,
    amount: u64,
