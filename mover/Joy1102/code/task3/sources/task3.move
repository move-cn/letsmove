module task3::joy1102nft {
    ...
    // otw
    public struct JOY1102NFT has drop {}
    ...
    fun init(otw: JOY1102NFT, ctx: &mut sui::tx_context::TxContext) {
        let keys = vector[
            utf8(b"name"),
            utf8(b"image_url"),
        ];
        ...
        let values = vector[
            utf8(b"{name}"),
            utf8(b"https://avatars.githubusercontent.com/u/81794441"),
        ];
