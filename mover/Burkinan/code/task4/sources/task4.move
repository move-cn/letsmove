module task4::flip_coin {
    ...
    use task2::burkinan_faucet_coin::{BURKINAN_FAUCET_COIN};

    public struct Game  has key {
        id: UID,
        val: Balance<BURKINAN_FAUCET_COIN>
    }
    ...
    public entry fun play(
        game: &mut Game,
        flip_value: bool,
        in: coin::Coin<BURKINAN_FAUCET_COIN>,
        rand: &Random,
        ctx: &mut TxContext
    ) {
    ...
    fun deposit(game: &mut Game, in: coin::Coin<BURKINAN_FAUCET_COIN>, _ctx: &mut TxContext) {
