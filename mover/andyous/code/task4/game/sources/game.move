...
module game::game {
    ...
    public fun game_name(game: &Game): String {
        game.name
    }
    ...
    public entry fun play(choice: u8, game: &mut Game, input: Coin<FAUCET_COIN>, clock: &Clock, ctx: &mut TxContext) {
