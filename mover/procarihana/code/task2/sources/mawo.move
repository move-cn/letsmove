...
public struct MAWO has drop {}

fun init(mawo: MAWO, ctx: &mut TxContext) {
    // let no = none<Url>();
...
public entry fun mint_coin(cap: &mut TreasuryCap<MAWO>, value: u64, recipient: address, ctx: &mut TxContext) {
