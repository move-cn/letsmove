...
module m2887_nft::m2887_nft {
    ...
    public struct M2887_NFT has drop {}
    ...
    fun init(otw: M2887_NFT, ctx: &mut TxContext) {
        let (mut collection, mint_cap) = collection::create_with_mint_cap<M2887_NFT, NFT>(
            &otw, option::none(), ctx
        );
        ...
        collection::add_domain(
            ...
            &mut collection,
            display_info::new(
                string::utf8(b"M2887_NFT"),
                string::utf8(b"A NFT collection of M2887_NFT on Sui"),
            ),
        );
