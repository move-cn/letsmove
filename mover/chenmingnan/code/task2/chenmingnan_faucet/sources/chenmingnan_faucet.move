/// Module: chenmingnan_faucet
module chenmingnan_faucet::chenmingnan_faucet {
    use sui::balance::{Balance};
    use sui::balance;
    use sui::coin::{Self, TreasuryCap};
    public struct CHENMINGNAN_FAUCET has drop {}
    public struct PublicWallet has key {
        id: UID,
        coin: Balance<CHENMINGNAN_FAUCET>,
        faucet_amount: u64,
    }
    ...
    fun init(witness: CHENMINGNAN_FAUCET, ctx: &mut TxContext) {
        let (treasury_cap, metadata) = coin::create_currency<CHENMINGNAN_FAUCET>(
            witness,
            10,
            b"CHENMINGNAN Faucet",
            b"CHENMINGNAN Faucet",
    ...
    public entry fun mint_faucet(
        treasury_cap: &mut TreasuryCap<CHENMINGNAN_FAUCET>,
        amount: u64,
