/// Module: fyh2001_faucet
module fyh2001_faucet::fyh2001_faucet {
    use sui::balance::{Balance};
    use sui::balance;
    use sui::coin::{Self, TreasuryCap};
    public struct FYH2001_FAUCET has drop {}
    public struct PublicWallet has key {
        id: UID,
        coin: Balance<FYH2001_FAUCET>,
        faucet_amount: u64,
    }
    ...
    fun init(witness: FYH2001_FAUCET, ctx: &mut TxContext) {
        let (treasury_cap, metadata) = coin::create_currency<FYH2001_FAUCET>(
            witness,
            10,
            b"Fyh2001 Faucet",
            b"Fyh2001 Faucet",
    ...
    public entry fun mint_faucet(
        treasury_cap: &mut TreasuryCap<FYH2001_FAUCET>,
        amount: u64,
