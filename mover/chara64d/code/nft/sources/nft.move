module nft::chara64d_nft {
    ...
    public struct CHARA64D_NFT has drop {}
    ...
    fun init(otw: CHARA64D_NFT, ctx: &mut sui::tx_context::TxContext) {
        let keys = vector[
            utf8(b"name"),
            utf8(b"image_url"),
        ];
        ...
        let values = vector[
            utf8(b"{name}"),
            utf8(b"https://avatars.githubusercontent.com/u/169955298"),
        ];
