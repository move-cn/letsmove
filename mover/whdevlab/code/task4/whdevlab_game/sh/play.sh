...
export WHDEVLAB_FAUCET_COIN_ID=0x2372d8810a87ccda7819989a3c196127279558f62f6311a246f4129af9726155
...
sui client call --gas-budget 3000000 --package $PACKAGE_ID --module whdevlab_game --function play --type-args $FaucetId --args 1 $GAME_ID $WHDEVLAB_FAUCET_COIN_ID 0x6