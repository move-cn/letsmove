...
/// Module: whdevlab_swap
module whdevlab_swap::whdevlab_swap {
    use sui::balance;
    ...
    public entry fun deposit_a<CoinA,CoinB>(bank:&mut Bank<CoinA,CoinB>,a:Coin<CoinA>,amount:u64,_:&mut TxContext){
