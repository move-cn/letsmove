...
export COINB=0x58262ebb92466e316bdf468fead81d7794644ea9f6042fc29503885c64649c08
sui client call --gas-budget 7500000 --package $PACKAGE_ID --module whdevlab_swap --function swap_b_a --type-args $COIN_TYPE $FAUCET_TYPE  --args $BANK_ID $COINB