...
sui client call --gas-budget 7500000 --package $PACKAGE_ID --module whdevlab_swap --function withdraw_a --type-args $COIN_TYPE $FAUCET_TYPE  --args 0x7f97bef079a6e6c0f3a8e34bf1f5f6e74f56cb6f65cd0b49793e23bf142651e6 $BANK_ID 10000