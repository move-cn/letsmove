module move_faucet::faucetcoin {
    use sui::coin::{Self, TreasuryCap};

    public struct FAUCETCOIN has drop {}

    fun init(waitness: FAUCETCOIN, ctx: &mut sui::tx_context::TxContext) {
        let (treasury_cap, meta) = coin::create_currency(waitness, 8, b"93503087 Faucet", b"93503087 Faucet", b"93503087 Faucet", option::none(), ctx);
