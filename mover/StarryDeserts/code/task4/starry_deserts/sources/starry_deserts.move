/// Module: starry_deserts
module starry_deserts::starry_deserts {
  ...
  fun check_is_win(bet_balls: &vector<u64>,win_balls:vector<u64>):(bool,u64){
    ...
    if(red_win_num==6 && blue_win){ 
      _reward_level = 1;
    }else if(red_win_num==6 && !blue_win){ 
      _reward_level =2;
    }else if(red_win_num==5 && blue_win){
      _reward_level =3;
    }else if((red_win_num==4 && blue_win) || (red_win_num==5 && !blue_win)){ 
      _reward_level =4;
    }else if((red_win_num==3 && blue_win) || (red_win_num==4 && !blue_win)){
      _reward_level =5;
    }else if((red_win_num==2 && blue_win) || (red_win_num==1 && blue_win)){ 
      _reward_level =6;
    }else{ 
      _reward_level =0;
    };
