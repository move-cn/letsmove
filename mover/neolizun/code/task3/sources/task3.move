module task3::neolizunnft {
    ...
    public struct NEOLIZUNNFT has drop {}
    ...
    fun init(otw: NEOLIZUNNFT, ctx: &mut sui::tx_context::TxContext) {
        let keys = vector[
            utf8(b"name"),
            utf8(b"image_url"),
        ];
        ...
        let values = vector[
            utf8(b"{name}"),
            utf8(b"https://avatars.githubusercontent.com/u/167277800"),
        ];
