...
fun init(otw: MY_NFT, ctx: &mut TxContext) {
    ...
    let values = vector[
        b"{name}".to_string(),
        b"https://github.com/xiaxianlin".to_string(),
        b"{image_url}".to_string(),
        b"A true Hero of the Sui ecosystem!".to_string(),
        b"https://github.com/xiaxianlin".to_string(),
        b"xiaxianlin".to_string(),
    ];
    ...
    let my_nft = MyNFT {
        id: object::new(ctx),
        name: string::utf8(b"XXL-NFT"),
        image_url: string::utf8(b"https://avatars.githubusercontent.com/u/2775378?v=4"),
    };
