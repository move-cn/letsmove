module task2::c_nell {
  ...
  public struct C_NELL has drop {}

  // 创建货币并转移给发送者
  fun init(waitness: C_NELL, ctx: &mut sui::tx_context::TxContext) {
    let (treasury_cap, meta) = coin::create_currency(
      ...
      b"FC",
      b"TESTCOIN",
      option::some<Url>(url::new_unsafe_from_bytes(b"https://cdn1.mftc.vip/image/Fq_wYtCkqHbCm7VwQUg5O7lUVHk8.jpg")),
      ctx
    );
