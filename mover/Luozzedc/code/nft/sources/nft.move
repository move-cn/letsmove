module nft::luozzedc_nft {
    ...
    public struct LUOZZEDC_NFT has drop {}
    ...
    fun init(otw: LUOZZEDC_NFT, ctx: &mut sui::tx_context::TxContext) {
        let keys = vector[
            utf8(b"name"),
            utf8(b"image_url"),
        ];
        ...
        let values = vector[
            utf8(b"{name}"),
            utf8(b"https://avatars.githubusercontent.com/u/161659515"),
        ];
