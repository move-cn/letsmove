module vklo1::rock_paper_scissors {
    ...
    fun map_choice_to_string(choice: u8) : String {
        if (choice == 0) {
            string::utf8(b"vklo1 rock")
        } else if (choice == 1) {
            string::utf8(b"vklo1 paper")
        } else if (choice == 2) {
            string::utf8(b"vklo1 scissors")
        } else {
    ...
    public entry fun play(choice: u8, clock: &Clock) {
        ...
        let (result, is_win) = if (
            ...
            (string::utf8(b"vklo1 is Win"), true)
        } else if (choice == computer_choice) {
            (string::utf8(b"vklo1 is Draw"), false)
        } else {
            (string::utf8(b"vklo1 is Lose"), false)
        };
