...
import {withdrawCoin} from "navi-sdk/src/libs/PTB/commonFunctions.ts";
...
export function PtbBlock() {
    ...
    const startPtb =async () => {
        ...
        console.log('deposit Sui：', suiAmount)
        ...
        console.log(' loan NUSDC：', nUSDCAmount)
        ...
        console.log('repayment NUSDC：', nUSDCAmount)
        ...
        //withdrawCoin
        await withdrawCoin(tx,suiPoolConfig,suiAmount)
    }
