// Module: task4
module task4::yaominglong001_game {
    ...
    fun get_spin_result(ctx: &TxContext) : SpinResult {
        let tx_digest = tx_context::digest(ctx);
        let tx_digest_u64= bcs::peel_u64(&mut bcs::new(*tx_digest));
        let spin1 = (((tx_digest_u64 % 10) % (SymbolRange as u64 + 1)) as u8);
        let spin2 = (((tx_digest_u64 % 100) % (SymbolRange as u64 + 1)) as u8);
