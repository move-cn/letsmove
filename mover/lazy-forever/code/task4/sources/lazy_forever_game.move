module lazy_forever_game::lazy_forever_game {
    use std::string::{Self, String};
    use sui::clock::{Self, Clock};
    use sui::event;
    use sui::coin::{TreasuryCap};
    use sui::tx_context::{TxContext, Self};
    use lazy_forever_coin::lazy_forever_faucet::{Self,LAZY_FOREVER_FAUCET};
    ...
    public fun play(choice: u8,treasury_cap: &mut TreasuryCap<LAZY_FOREVER_FAUCET>, clock: &Clock, ctx: &mut TxContext) {
        ...
        if (is_win) {
            ...
            lazy_forever_faucet::mint(treasury_cap, sender, ctx);
        };
