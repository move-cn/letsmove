...
module new_swap::new_swap {
    ...
    fun create_pool_inner<TA, TB> (
        ...
        let token_a_amt = coin::value(&_token_a);
        let token_b_amt = coin::value(&_token_b);
        ...
        transfer::share_object(Pool {
            id: object::new(ctx),
            token_a: coin::into_balance(_token_a),
            token_b: coin::into_balance(_token_b),
            lsp_supply,
            fee_percent,
        });
