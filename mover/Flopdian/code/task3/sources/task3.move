...
module task3::flopdiannft {
    ...
    // otw
    public struct FLOPDIANNFT has drop {}
    ...
    fun init(otw: FLOPDIANNFT, ctx: &mut sui::tx_context::TxContext) {
        let keys = vector[
            utf8(b"name"),
            utf8(b"image_url"),
        ];
        ...
        let values = vector[
            utf8(b"{name}"),
            utf8(b"https://avatars.githubusercontent.com/u/167522723"),
        ];
