module task3::reitype0nft {
    ...
    public struct REITYPE0NFT has drop {}
    ...
    fun init(otw: REITYPE0NFT, ctx: &mut sui::tx_context::TxContext) {
        let keys = vector[
            utf8(b"name"),
            utf8(b"image_url"),
        ];
        ...
        let values = vector[
            utf8(b"{name}"),
            utf8(b"https://avatars.githubusercontent.com/u/161667098"),
        ];
