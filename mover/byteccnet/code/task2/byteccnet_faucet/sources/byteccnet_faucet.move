/*
/// Module: byteccnet_faucet
module byteccnet_faucet::byteccnet_faucet {
...
module byteccnet_faucet::byteccnet_faucet {
    ...
    public struct BYTECCNET_FAUCET has drop {}
    public struct PublicWallet has key {
        id: UID,
        coin: Balance<BYTECCNET_FAUCET>,
        faucet_amount: u64,
    }
    ...
    fun init(witness: BYTECCNET_FAUCET, ctx: &mut TxContext) {
        let (treasury_cap, metadata) = coin::create_currency<BYTECCNET_FAUCET>(
            witness,
            10,
            b"byteccnet Faucet",
            b"byteccnet Faucet",
    ...
    public entry fun mint_faucet(
        treasury_cap: &mut TreasuryCap<BYTECCNET_FAUCET>,
        amount: u64,
