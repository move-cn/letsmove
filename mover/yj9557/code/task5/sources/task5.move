...
use task2::faucet_yj9957::FAUCET_YJ9957;
use task2::yj9957::YJ9957;
...
public struct Swap has key{
    id: UID,
    coin: Balance<YJ9957>,
    faucet_coin: Balance<FAUCET_YJ9957>
}
...
fun init(ctx: &mut TxContext) {
    ...
    let swap = Swap{
        id: object::new(ctx),
        coin: balance::zero<YJ9957>(),
        faucet_coin: balance::zero<FAUCET_YJ9957>()
    };
...
public entry fun swap_coin_to_faucet(swap: &mut Swap, userCoin: &mut Coin<YJ9957>, userCoinAmount: u64, ctx: &mut TxContext) {
...
public entry fun swap_faucet_to_coin(swap: &mut Swap, userFaucetCoin: &mut Coin<FAUCET_YJ9957>, userFaucetCoinAmount: u64, ctx: &mut TxContext) {
...
public entry fun save_coin(_: &AdminCap, swap: &mut Swap, userCoin: &mut Coin<YJ9957>, userCoinAmount: u64, userFaucetCoin: &mut Coin<FAUCET_YJ9957>, userFaucetCoinAmount: u64, ctx: &mut TxContext) {
    if (userCoinAmount > 0) {
