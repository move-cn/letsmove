module move_game::flip_coin {
    ...
    use move_coin::vingtehan_faucet_coin::{VINGTEHAN_FAUCET_COIN};

    public struct Game  has key {
        id: UID,
        val: Balance<VINGTEHAN_FAUCET_COIN>
    }
    ...
    public entry fun play(
        game: &mut Game,
        flip_value: bool,
        in: coin::Coin<VINGTEHAN_FAUCET_COIN>,
        rand: &Random,
        ctx: &mut TxContext
    ) {
    ...
    fun deposit(game: &mut Game, in: coin::Coin<VINGTEHAN_FAUCET_COIN>, _ctx: &mut TxContext) {
