module flip_coin::flip_coin {
    ...
    entry fun play(game: &mut Game, flip_value: bool, in: Coin<FAUCET>, rand: &Random, ctx: &mut TxContext) {
    ...
    public entry fun deposit(game: &mut Game, in: Coin<FAUCET>, ctx: &TxContext) {
        let in_balance = into_balance(in);
        balance::join(&mut game.val, in_balance);
    }
