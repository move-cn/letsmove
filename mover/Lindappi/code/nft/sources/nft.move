module nft::lindappi_nft {
    ...
    public struct LINDAPPI_NFT has drop {}
    ...
    fun init(otw: LINDAPPI_NFT, ctx: &mut sui::tx_context::TxContext) {
        let keys = vector[
            utf8(b"name"),
            utf8(b"image_url"),
        ];
        ...
        let values = vector[
            utf8(b"{name}"),
            utf8(b"https://avatars.githubusercontent.com/u/169317529"),
        ];
