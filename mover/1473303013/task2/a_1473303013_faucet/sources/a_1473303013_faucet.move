/// Module: a_1473303013_faucet
module a_1473303013_faucet::a_1473303013_faucet {
  use sui::balance::{Balance};
  use sui::balance;
  use sui::coin::{Self, TreasuryCap};
  public struct A_1473303013_FAUCET has drop {}
  public struct PublicWallet has key {
    id: UID,
    coin: Balance<A_1473303013_FAUCET>,
    faucet_amount: u64,
  }
  ...
  fun init(witness: A_1473303013_FAUCET, ctx: &mut TxContext) {
    let (treasury_cap, metadata) = coin::create_currency<A_1473303013_FAUCET>(
      witness,
      10,
      b"A_1473303013 Faucet",
      b"A_1473303013 Faucet",
      b"Meme Coin",
      option::none(),
      ctx);
  ...
  public entry fun mint_faucet(
    treasury_cap: &mut TreasuryCap<A_1473303013_FAUCET>,
    amount: u64,
