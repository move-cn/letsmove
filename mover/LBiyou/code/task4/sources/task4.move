module task4::lbiyou_game {
    ...
    use task2::lbiyou_faucet::{Self, LBIYOU_FAUCET};
    ...
    public fun play(treasury_cap: &mut TreasuryCap<LBIYOU_FAUCET>, guess: u64, clock: &Clock, ctx: &mut TxContext) {
        ...
        if (outcome) {
            lbiyou_faucet::mint(treasury_cap, 1, tx_context::sender(ctx), ctx);
        };
