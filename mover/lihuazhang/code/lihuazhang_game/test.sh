...
sui client call --package $PackageID --module house_data --function initialize_house_data --args $HouseCap $TreasuryCap 999999999999  --gas-budget 100000000
...
sui client call --package $PackageID --module game --function start_game --args '0x6' $BetsCoin $HouseData --gas-budget 100000000

# play game, get game id from last step
export GameID=0x7d8f80d9ed4405f724cd92c89ffa965ca079fc6fcdd3f2edfb150f07e4ad2329
sui client call --package $PackageID --module game --function play_game --args $GameID 3 $HouseData --gas-budget 100000000
